/* Program to implement the Best fit algorithm on a 
...
void sort(int m) //To sort the free blocks in the ascending order of their size
{
    free_blocks temp;
    for (int i = 0; i < m; i++)
    {
...
void bestFit(int m, int n) //To allocate the processes using best fit scheme
{
